...
const PhoneScreen = ({country,region,selectCountry,selectRegion,zip,descriptn}) => {
  return (
    <div>
      <HeaderContainer />
            ...
            <div className="w-100 ">
              <div>
                <div className="w-100 flex flex-row mb1">
                  <div className="w-40 tl ">PRICE</div>
                  <div className="w-20 tc ">QUANTITY</div>
                  <div className="w-40 tr">TOTAL</div>
                </div>
                <Divider className="mo" />
              </div>
              <div>
              <div className="w-100 flex flex-column  mb2 mt2">
<div>
<div className="w-100 flex flex-row">
                  ...
                  <div className=" h-100 flex items-center mr2">
                    <RiDeleteBin5Line />
                      ...
                      <div className="w-40 ivh pointer bg-orange mr3">img</div>
                  ...
                  <div className="flex flex-row justify-center mb2 mt2">
                  <div className="w-40 tl black f5 pointer ">UGX 70000</div>
              ...
              />
                  ...
                  <div className="w-40 tr black pointer f5">UGX 70000</div>
                  </div>
                </div>
                <Divider className="mo" />
              </div>
