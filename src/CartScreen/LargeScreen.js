...
import { selectCountry, selectRegion, zipCode,description} from  "../Redux/Actions/Cart/Actions"
...
const LargeScreen = ({country,region,selectCountry,selectRegion,zip,descriptn}) => {
  return (
    <div>
      <HeaderContainer />
      <div className="w-100 flex justify-center">
        <div className=" innerCont">
          ...
          <div className=" mt3 w-100 mb4 flex items-baseline justify-between flex-row">
            <div className="tabCon ">
              <div>
                <div className="w-100 flex flex-row mb1">
                  <div className="w-50">PRODUCT</div>
                  <div className="w-20 tc ">PRICE</div>
                  <div className="w-10 tc ">QUANTITY</div>
                  <div className="w-20 tr">TOTAL</div>
                </div>
              ...
              <div className="w-100 flex flex-row items-center mb2 mt2">
                  ...
                  <div className=" h-100 flex items-center mr2">
                    <RiDeleteBin5Line />
                      ...
                      <div className="w-33 ivh pointer bg-orange mr3">img</div>
                      <div className="flex flex-column mb1   justify-center">
                          <div className="black pointer">Name</div>
                          <div className="pointer">lable/size</div>
                      </div>

                  </div>
                  <div className="w-20 tc black f5 pointer ">UGX 70000</div>
              ...
              />
                  ...
                  <div className="w-20 tr black pointer f5">UGX 70000</div>
                </div>
                <Divider className="mo" />
              </div>
              <div className="w-100 flex flex-row items-center justify-between mt4">
                  ...
                  <div className=" mr2 ">
                    ...
                    <div className="black pointer">CONTINUE SHOPPING</div></div>
                  <div className="flex flex-row">
                  ...
                  <div className="mr2 ">
                    ...
                    <div className="black pointer">UPDATE CART</div></div>
              </div>
            </div>
            <div className=" autoh w-25 items-center flex flex-column ba reciptbg b--black-10">
                <div className="w-90">
