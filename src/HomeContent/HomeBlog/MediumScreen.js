...
const MediumScreen = ({ blogs,seeArrow,notArrow,bArrow }) => {
  ...
  return (
    <div className="mt4">
      ...
      <div className="mt3 relative" onMouseEnter={()=>seeArrow()} onMouseLeave={()=>notArrow()}>
        <Carousel ref={customSlider} {...settings}>
          {blogs.map((blog) => (
           <div>
              ...
              <div className="w-90 itH pointer bg-purple"></div>
              <div className="flex  w-90 flex-column justify-center  items-center">
                  <div className="pointer black f4 fw5">{blog.title}</div>
        ...
        <Motion
      defaultStyle={{ translateX: -30, opacity: 0 }}
      style={{
        translateX: spring(bArrow?-23:-30, presets.gentle),
...
<IconContext.Provider
                      ...
                      className="absolute bg-white flex pt1 pb1 items-center arrowB pointer"
                      onClick={()=>previous()}
                      >
                        <BsChevronLeft />
                      </div>
...
<IconContext.Provider
                      ...
                      <div
                        style={{
                         ...
                         className="absolute bg-white flex pt1 pb1 items-center arrowB right-0 pointer"
                         onClick={()=>next()}
                         >
                        <BsChevronRight />
                      </div>
