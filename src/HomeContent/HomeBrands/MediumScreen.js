...
const MediumScreen = ({ brands, showBorder, hideBorder,arrows,arrow,noArrow }) => {
  ...
  return (
    <div>
      ...
      style={{
        translateX: spring(arrows?-23:-30, presets.gentle),
...
<IconContext.Provider
                      ...
                      className="absolute bg-white  arrowcont pointer"
                      onClick={()=>previous()}
                      >
                        <BsChevronLeft />
                      </div>
...
<IconContext.Provider
                      ...
                      <div
                        style={{
                         ...
                         className="absolute bg-white  arrowcont right-0 pointer"
                         onClick={()=>next()}
                         >
                        <BsChevronRight />
                      </div>
